...
5. test one simultaneous different project/context;
6. verify normal process cleanup and, if cheap, one abrupt-owner-exit case;
7. archive the result as Experiment 007 and update `EXPERIMENTS.md`.
